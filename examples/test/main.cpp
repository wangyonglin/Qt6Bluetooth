...
\
    ...
    service.show();
    service.start("C barcode scanner");
    app.connect(&service,&Qt6Rockchip::Bluetooth::BluetoothService::transmit,[&](const QByteArray & msg){
        qDebug()  << "bluetooth:" <<msg.toStdString();
    });
