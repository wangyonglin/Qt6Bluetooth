/****************************************************************************
** Meta object code from reading C++ file 'Rockchip_Bluetooth_DeviceService.h'
**
...
#include "../../../libQt6Rockchip/Rockchip_Bluetooth_DeviceService.h"
...
#error "The header file 'Rockchip_Bluetooth_DeviceService.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_CLASSRockchipSCOPEBluetoothSCOPEDeviceServiceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRockchipSCOPEBluetoothSCOPEDeviceServiceENDCLASS = QtMocHelpers::stringData(
    "Rockchip::Bluetooth::DeviceService",
    "reject",
    "",
    "logerr",
    "resolve",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRockchipSCOPEBluetoothSCOPEDeviceServiceENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Rockchip::Bluetooth::DeviceService::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSRockchipSCOPEBluetoothSCOPEDeviceServiceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRockchipSCOPEBluetoothSCOPEDeviceServiceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRockchipSCOPEBluetoothSCOPEDeviceServiceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Rockchip::Bluetooth::DeviceService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DeviceService::*)(const QString & );
            if (_t _q_method = &DeviceService::reject; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DeviceService::*)(const QLowEnergyCharacteristic & , const QByteArray & );
            if (_t _q_method = &DeviceService::resolve; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject *Rockchip::Bluetooth::DeviceService::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Rockchip::Bluetooth::DeviceService::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRockchipSCOPEBluetoothSCOPEDeviceServiceENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int Rockchip::Bluetooth::DeviceService::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void Rockchip::Bluetooth::DeviceService::reject(const QString & _t1)
{
...
// SIGNAL 1
void Rockchip::Bluetooth::DeviceService::resolve(const QLowEnergyCharacteristic & _t1, const QByteArray & _t2)
{
